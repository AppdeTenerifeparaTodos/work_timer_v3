...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'pl': {
      ...
      'pet_reward_theme_title': 'Motyw Aplikacji',
      'pet_reward_theme_desc': 'Odblokowano ciemny motyw neonowy!',
      'pet_reward_evolution_title': 'Animacja Ewolucji',
      'pet_reward_evolution_desc': 'Odblokowano ekskluzywną animację ewolucji!',
      'pet_reward_master_title': 'Full Stack Master',
      'pet_reward_master_desc': 'Kolekcja ukończona! Odznaka Full Stack Master!',
      'pet_rewards_pets': 'maskotek',
      ...
      // Pomodoro – etykiety statusu i statystyk
      'pomodoro_status_focus': 'FOKUS',
      'pomodoro_status_break': 'PRZERWA',
      'pomodoro_status_relax': 'RELAKS',
      'pomodoro_status_pause': 'PAUZA',
      'pomodoro_status_ready': 'GOTOWY',
      'pomodoro_sessions_label': 'SESJE',
      'pomodoro_today_total': 'DZIŚ ŁĄCZNIE',
      'pomodoro_session_record': 'REKORD SESJI',
      // Gry / reset
      'reset_levels': 'Reset poziomów',
      'progress_levels_reset': 'Postęp poziomów zresetowany',
      'progress_reset': 'Postęp zresetowany',
      'ok': 'OK',
      // Backup / import
      'backup_no_folder': 'Brak folderu z backupem',
      'backup_no_files': 'Brak plików backupu (.json)',
      'import_legacy_format': 'Zaimportowano historię (stary format pliku)',
      'import_full': 'Zaimportowano historię, cele i wydarzenia',
      'backup_unknown_format': 'Nieznany format pliku backupu',
      'backup_share_subject': 'Backup WorkStudyTimer',
      // Języki (tooltip)
      'lang_polish': 'Polski',
      ...
      // Cele
      'goal_stop': 'Zatrzymaj',
      'goal_start_with': 'Start z tym celem',
      'timer_started': 'Timer uruchomiony:',
      'share_backup': 'Udostępnij backup',
      // Typy aktywności (statystyki)
      'type_nauka': 'Nauka',
      'type_praca_platna': 'Praca płatna',
      'type_praca_nieplatna': 'Praca niepłatna',
      // DevPet
      'pet_collection_collected': 'zebrano',
    },
    ...
    'es': {
      ...
      'pet_reward_theme_title': 'Tema de la aplicación',
      'pet_reward_theme_desc': '¡Tema oscuro neón desbloqueado!',
      'pet_reward_evolution_title': 'Animación de evolución',
      'pet_reward_evolution_desc': '¡Animación exclusiva de evolución desbloqueada!',
      'pet_reward_master_title': 'Full Stack Master',
      'pet_reward_master_desc': '¡Colección completada! Insignia Full Stack Master!',
      'pet_rewards_pets': 'mascotas',
      ...
      'pomodoro_status_focus': 'FOCO',
      'pomodoro_status_break': 'PAUSA',
      'pomodoro_status_relax': 'RELAJO',
      'pomodoro_status_pause': 'PAUSA',
      'pomodoro_status_ready': 'LISTO',
      'pomodoro_sessions_label': 'SESIONES',
      'pomodoro_today_total': 'HOY EN TOTAL',
      'pomodoro_session_record': 'RÉCORD DE SESIONES',
      'reset_levels': 'Restablecer niveles',
      'progress_levels_reset': 'Progreso de niveles restablecido',
      'progress_reset': 'Progreso restablecido',
      'ok': 'OK',
      'backup_no_folder': 'No hay carpeta de copia',
      'backup_no_files': 'No hay archivos de copia (.json)',
      'import_legacy_format': 'Historia importada (formato antiguo)',
      'import_full': 'Historia, objetivos y eventos importados',
      'backup_unknown_format': 'Formato de archivo de copia desconocido',
      'backup_share_subject': 'Backup WorkStudyTimer',
      'lang_polish': 'Polski',
      'lang_spanish': 'Español',
      'lang_english': 'English',
      'goal_stop': 'Detener',
      'goal_start_with': 'Iniciar con este objetivo',
      'timer_started': 'Temporizador iniciado:',
      'share_backup': 'Compartir copia',
      'type_nauka': 'Estudio',
      'type_praca_platna': 'Trabajo remunerado',
      'type_praca_nieplatna': 'Trabajo no remunerado',
      'pet_collection_collected': 'recogidas',
    },
    ...
    'en': {
      ...
      'pet_reward_theme_title': 'App Theme',
      'pet_reward_theme_desc': 'Dark neon theme unlocked!',
      'pet_reward_evolution_title': 'Evolution Animation',
      'pet_reward_evolution_desc': 'Exclusive evolution animation unlocked!',
      'pet_reward_master_title': 'Full Stack Master',
      'pet_reward_master_desc': 'Collection complete! Full Stack Master badge!',
      'pet_rewards_pets': 'pets',
      ...
      'pomodoro_status_focus': 'FOCUS',
      'pomodoro_status_break': 'BREAK',
      'pomodoro_status_relax': 'RELAX',
      'pomodoro_status_pause': 'PAUSE',
      'pomodoro_status_ready': 'READY',
      'pomodoro_sessions_label': 'SESSIONS',
      'pomodoro_today_total': 'TODAY TOTAL',
      'pomodoro_session_record': 'SESSION RECORD',
      'reset_levels': 'Reset levels',
      'progress_levels_reset': 'Level progress reset',
      'progress_reset': 'Progress reset',
      'ok': 'OK',
      'backup_no_folder': 'No backup folder',
      'backup_no_files': 'No backup files (.json)',
      'import_legacy_format': 'History imported (legacy format)',
      'import_full': 'History, goals and events imported',
      'backup_unknown_format': 'Unknown backup file format',
      'backup_share_subject': 'Backup WorkStudyTimer',
      'lang_polish': 'Polish',
      'lang_spanish': 'Spanish',
      'lang_english': 'English',
      'goal_stop': 'Stop',
      'goal_start_with': 'Start with this goal',
      'timer_started': 'Timer started:',
      'share_backup': 'Share backup',
      'type_nauka': 'Study',
      'type_praca_platna': 'Paid work',
      'type_praca_nieplatna': 'Unpaid work',
      'pet_collection_collected': 'collected',
    },
  };
